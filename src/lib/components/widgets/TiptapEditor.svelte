...
{#if editor}
  <div class="control-group">
    <div class="button-group">
      ...
      <button onclick={() => editor && editor && editor.chain().focus().unsetAllMarks().run()}>Clear marks</button>
      <button onclick={() => editor && editor && editor.chain().focus().clearNodes().run()}>Clear nodes</button>
      <button
      ...
      <button onclick={() => editor && editor.chain().focus().setHorizontalRule().run()}>
        Horizontal rule
      </button>
      <button onclick={() => editor && editor.chain().focus().setHardBreak().run()}>Hard break</button>
      <button
      ...
      <button
        onclick={() => editor && editor.chain().focus().setColor('#958DF1').run()}
